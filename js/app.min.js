(() => {
    ...
    let o = {
        ...
        formClean(t) {
            t.reset(), setTimeout((() => {
                ...
                for (let e = 0; e < s.length; e++) {
                    const t = s[e];
                    t.parentElement.classList.remove("_form-focus"), t.classList.remove("_form-focus"), o.removeError(t)
                }
    ...
    function d(e = {}, t = {}) {
        Object.keys(t).forEach((s => {
            void 0 === e[s] ? e[s] = t[s] : c(t[s]) && c(e[s]) && Object.keys(t[s]).length > 0 && d(e[s], t[s])
        }))
    }
    e.select = new class {
        ...
        selectInit(e, t) {
            ...
            if (i.classList.add(this.selectClasses.classSelect), e.parentNode.insertBefore(i, e), i.appendChild(e), e.hidden = !0, t && (e.dataset.id = t), this.getSelectPlaceholder(e) && (e.dataset.placeholder = this.getSelectPlaceholder(e).value, this.getSelectPlaceholder(e).label.show)) {
            ...
            i.insertAdjacentHTML("beforeend", `<div class="${this.selectClasses.classSelectBody}"><div hidden class="${this.selectClasses.classSelectOptions}"></div></div>`), this.selectBuild(e), e.dataset.speed = e.dataset.speed ? e.dataset.speed : "150", e.addEventListener("change", (function (e) {
                s.selectChange(e)
            }))
        }
        selectBuild(e) {
            const t = e.parentElement;
            t.dataset.id = e.dataset.id, e.dataset.classModif && t.classList.add(`select_${e.dataset.classModif}`), e.multiple ? t.classList.add(this.selectClasses.classSelectMultiple) : t.classList.remove(this.selectClasses.classSelectMultiple), e.hasAttribute("data-checkbox") && e.multiple ? t.classList.add(this.selectClasses.classSelectCheckBox) : t.classList.remove(this.selectClasses.classSelectCheckBox), this.setSelectTitleValue(t, e), this.setOptions(t, e), e.hasAttribute("data-search") && this.searchActions(t), e.hasAttribute("data-open") && this.selectAction(t), this.selectDisabled(t, e)
        }
        selectsActions(e) {
            const t = e.target,
                s = e.type;
        ...
        selectAction(e) {
            ...
            s.classList.contains("_slide") || (e.classList.toggle(this.selectClasses.classSelectOpen), i(s, t.dataset.speed))
        }
        ...
        getOptions(e) {
            ...
            if (i.length > 0) {
                let n = "";
                return (this.getSelectPlaceholder(e) && !this.getSelectPlaceholder(e).show || e.multiple) && (i = i.filter((e => e.value))), n += t ? `<div ${t} ${s} class="${this.selectClasses.classSelectOptionsScroll}">` : "", i.forEach((t => {
        ...
        getOption(e, t) {
            ...
            let r = "";
            return r += a ? `<a ${l} ${i} href="${a}" data-value="${e.value}" class="${this.selectClasses.classSelectOption}${n}${s}">` : `<button ${i} class="${this.selectClasses.classSelectOption}${n}${s}" data-value="${e.value}" type="button">`, r += this.getSelectElementContent(e), r += a ? "</a>" : "</button>", r
        }
        setOptions(e, t) {
        ...
        setSelectChange(e) {
            if (e.hasAttribute("data-validate") && o.validateInput(e), e.hasAttribute("data-submit") && e.value) {
        ...
        setLogging(e) {
            this.config.logging && function (e) {
                setTimeout((() => {
    ...
    function y(e) {
        return function (...t) {
            if (void 0 === t[0]) {
                for (let t = 0; t < this.length; t += 1) b.indexOf(e) < 0 && (e in this[t] ? this[t][e]() : S(this[t]).trigger(e));
                return this
            }
            return this.on(e, ...t)
        }
    ...
    const w = {
        ...
        on: function (...e) {
            ...
            function a(e) {
                ...
                if (n.indexOf(e) < 0 && n.unshift(e), S(t).is(s)) i.apply(t, n);
                    ...
                    const e = S(t).parents();
                    for (let t = 0; t < e.length; t += 1) S(e[t]).is(s) && i.apply(e[t], n)
                }
            }
                ...
                for (let e = 0; e < this.length; e += 1) {
                    ...
                    if (!s && a.dom7Listeners ? l = a.dom7Listeners[t] : s && a.dom7LiveListeners && (l = a.dom7LiveListeners[t]), l && l.length)
                        for (let e = l.length - 1; e >= 0; e -= 1) {
                            const s = l[e];
                            i && s.listener === i || i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i ? (a.removeEventListener(t, s.proxyListener, n), l.splice(e, 1)) : i || (a.removeEventListener(t, s.proxyListener, n), l.splice(e, 1))
                        }
                }
            }
            return this
        ...
        parent: function (e) {
            const t = [];
            for (let s = 0; s < this.length; s += 1) null !== this[s].parentNode && (e ? S(this[s].parentNode).is(e) && t.push(this[s].parentNode) : t.push(this[s].parentNode));
            return S(t)
        },
        parents: function (e) {
            const t = [];
        ...
        children: function (e) {
            ...
            for (let s = 0; s < this.length; s += 1) {
                ...
                for (let s = 0; s < i.length; s += 1) e && !S(i[s]).is(e) || t.push(i[s])
            }
            return S(t)
        },
        filter: function (e) {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !k(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== a && a.enumerable && (L(e[n]) && L(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : M(e[n], i[n]) : !L(e[n]) && L(i[n]) ? (e[n] = {}, i[n].__swiper__ ? e[n] = i[n] : M(e[n], i[n])) : e[n] = i[n])
                }
            }
        }
        return e
    ...
    function D(e) {
        return void 0 === e && (e = {}), _ || (_ = function (e) {
            ...
            const p = a.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                h = "Win32" === n;
            let f = "MacIntel" === n;
            return !d && f && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${r}x${o}`) >= 0 && (d = a.match(/(Version)\/([\d.]+)/), d || (d = [0, 1, "13_0_0"]), f = !1), c && !h && (l.os = "android", l.android = !0), (d || u || p) && (l.os = "ios", l.ios = !0), l
        }(e)), _
    }
    ...
    const G = {
        ...
        updateSlides: function () {
            ...
            let b = i.spaceBetween,
                ...
                C = 0;
            if (void 0 === a) return;
            "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * a), e.virtualSize = -b, l ? d.css({
                marginLeft: "",
                marginBottom: "",
                marginTop: ""
            }) : d.css({
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                if (E && e.grid.updateSlide(n, l, p, t), "none" !== l.css("display")) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        if (r && (l[0].style.transform = "none"), o && (l[0].style.webkitTransform = "none"), i.roundLengths) T = e.isHorizontal() ? l.outerWidth(!0) : l.outerHeight(!0);
                        else {
                            const e = s(a, "width"),
                                t = s(a, "padding-left"),
                                i = s(a, "padding-right"),
                        ...
                        r && (l[0].style.transform = r), o && (l[0].style.webkitTransform = o), i.roundLengths && (T = Math.floor(T))
                    } else T = (a - (i.slidesPerView - 1) * b) / i.slidesPerView, i.roundLengths && (T = Math.floor(T)), d[n] && (d[n].style[t("width")] = `${T}px`);
                    d[n] && (d[n].swiperSlideSize = T), m.push(T), i.centeredSlides ? (y = y + T / 2 + w / 2 + b, 0 === w && 0 !== n && (y = y - a / 2 - b), 0 === n && (y = y - a / 2 - b), Math.abs(y) < .001 && (y = 0), i.roundLengths && (y = Math.floor(y)), C % i.slidesPerGroup == 0 && u.push(y), h.push(y)) : (i.roundLengths && (y = Math.floor(y)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(y), h.push(y), y = y + T + b), e.virtualSize += T + b, w = T, C += 1
                }
            }
            if (e.virtualSize = Math.max(e.virtualSize, a) + g, l && r && ("slide" === i.effect || "coverflow" === i.effect) && n.css({
                    width: `${e.virtualSize+i.spaceBetween}px`
                }), i.setWrapperSize && n.css({
                    [t("width")]: `${e.virtualSize+i.spaceBetween}px`
                }), E && e.grid.updateWrapperSize(T, u, t), !i.centeredSlides) {
                const t = [];
            ...
            if (Object.assign(e, {
                ...
                P(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"), P(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
                const t = -e.snapGrid[0],
                    s = -e.slidesGrid[0];
                e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
            }
            if (p !== c && e.emit("slidesLengthChange"), u.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== S && e.emit("slidesGridLengthChange"), i.watchSlidesProgress && e.updateSlidesOffset(), !(o || i.cssMode || "slide" !== i.effect && "fade" !== i.effect)) {
        ...
        updateSlidesProgress: function (e) {
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                (p >= 0 && p < t.size - 1 || u > 1 && u <= t.size || p <= 0 && u >= t.size) && (t.visibleSlides.push(r), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)), r.progress = n ? -c : c, r.originalProgress = n ? -d : d
            }
        ...
        updateProgress: function (e) {
            ...
            const r = a,
                o = l;
            0 === i ? (n = 0, a = !0, l = !0) : (n = (e - t.minTranslate()) / i, a = n <= 0, l = n >= 1), Object.assign(t, {
                progress: n,
                isBeginning: a,
                isEnd: l
            }), (s.watchSlidesProgress || s.centeredSlides && s.autoHeight) && t.updateSlidesProgress(e), a && !r && t.emit("reachBeginning toEdge"), l && !o && t.emit("reachEnd toEdge"), (r && !a || o && !l) && t.emit("fromEdge"), t.emit("progress", n)
        },
    ...
    const N = {
        ...
        setTranslate: function (e, t) {
            ...
            let o, c = 0,
                d = 0;
            s.isHorizontal() ? c = i ? -e : e : d = e, n.roundLengths && (c = Math.floor(c), d = Math.floor(d)), n.cssMode ? l[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -c : -d : n.virtualTranslate || a.transform(`translate3d(${c}px, ${d}px, 0px)`), s.previousTranslate = s.translate, s.translate = s.isHorizontal() ? c : d;
        ...
        translateTo: function (e, t, s, i, n) {
            ...
            return 0 === t ? (a.setTransition(0), a.setTranslate(d), s && (a.emit("beforeTransitionStart", t, n), a.emit("transitionEnd"))) : (a.setTransition(t), a.setTranslate(d), s && (a.emit("beforeTransitionStart", t, n), a.emit("transitionStart")), a.animating || (a.animating = !0, a.onTranslateToWrapperTransitionEnd || (a.onTranslateToWrapperTransitionEnd = function (e) {
    ...
    function H(e) {
        ...
        let r = i;
        if (r || (r = a > l ? "next" : a < l ? "prev" : "reset"), t.emit(`transition${n}`), s && a !== l) {
    ...
    const j = {
        slideTo: function (e, t, s, i, n) {
            ...
            g >= o.length && (g = o.length - 1), (p || r.initialSlide || 0) === (d || 0) && s && a.emit("beforeSlideChangeStart");
            const v = -o[g];
            ...
            let S;
            if (S = l > p ? "next" : l < p ? "prev" : "reset", u && -v === a.translate || !u && v === a.translate) return a.updateActiveIndex(l), r.autoHeight && a.updateAutoHeight(), a.updateSlidesClasses(), "slide" !== r.effect && a.setTranslate(v), "reset" !== S && (a.transitionStart(s, S), a.transitionEnd(s, S)), !1;
            if (r.cssMode) {
                const e = a.isHorizontal(),
                    s = u ? v : -v;
                if (0 === t) {
            ...
            return a.setTransition(t), a.setTranslate(v), a.updateActiveIndex(l), a.updateSlidesClasses(), a.emit("beforeTransitionStart", t, i), a.transitionStart(s, S), 0 === t ? a.transitionEnd(s, S) : a.animating || (a.animating = !0, a.onSlideToWrapperTransitionEnd || (a.onSlideToWrapperTransitionEnd = function (e) {
                a && !a.destroyed && e.target === this && (a.$wrapperEl[0].removeEventListener("transitionend", a.onSlideToWrapperTransitionEnd), a.$wrapperEl[0].removeEventListener("webkitTransitionEnd", a.onSlideToWrapperTransitionEnd), a.onSlideToWrapperTransitionEnd = null, delete a.onSlideToWrapperTransitionEnd, a.transitionEnd(s, S))
        ...
        slidePrev: function (e, t, s) {
            ...
            let m = 0;
            if (void 0 !== h && (m = r.indexOf(h), m < 0 && (m = i.activeIndex - 1), "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && (m = m - i.slidesPerViewDynamic("previous", !0) + 1, m = Math.max(m, 0))), n.rewind && i.isBeginning) {
        ...
        slideToClickedSlide: function () {
            ...
            if (t.loop) {
                ...
                n = parseInt(C(e.clickedSlide).attr("data-swiper-slide-index"), 10), t.centeredSlides ? a < e.loopedSlides - i / 2 || a > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), E((() => {
                    e.slideTo(a)
                }))) : e.slideTo(a) : a > e.slides.length - i ? (e.loopFix(), a = s.children(`.${t.slideClass}[data-swiper-slide-index="${n}"]:not(.${t.slideDuplicateClass})`).eq(0).index(), E((() => {
                    e.slideTo(a)
                }))) : e.slideTo(a)
            } else e.slideTo(a)
        }
    ...
    const F = {
        loopCreate: function () {
            ...
            for (let e = 0; e < r.length; e += 1) n.append(C(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
            for (let e = l.length - 1; e >= 0; e -= 1) n.prepend(C(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass))
        },
        loopFix: function () {
            const e = this;
            ...
            if (t < i) {
                ...
                e.slideTo(o, 0, !1, !0) && 0 !== c && e.setTranslate((r ? -e.translate : e.translate) - c)
    ...
    function V(e) {
        ...
        !!a.noSwipingClass && "" !== a.noSwipingClass && o.target && o.target.shadowRoot && e.path && e.path[0] && (c = C(e.path[0]));
        ...
        if (a.noSwiping && (p ? function (e, t) {
                return void 0 === t && (t = this),
                    function t(s) {
                        return s && s !== u() && s !== m() ? (s.assignedSlot && (s = s.assignedSlot), s.closest(e) || t(s.getRootNode().host)) : null
                    }(t)
        ...
        if (Object.assign(n, {
                ...
                isScrolling: void 0,
                startMoving: void 0
            }), l.startX = h, l.startY = f, n.touchStartTime = T(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (n.allowThresholdMove = !1), "touchstart" !== o.type) {
            let e = !0;
            c.is(n.focusableElements) && (e = !1, "SELECT" === c[0].nodeName && (n.isTouched = !1)), s.activeElement && C(s.activeElement).is(n.focusableElements) && s.activeElement !== c[0] && s.activeElement.blur();
    ...
    function W(e) {
        ...
        if (!s.allowTouchMove) return C(o.target).is(i.focusableElements) || (s.allowClick = !1), void(i.isTouched && (Object.assign(a, {
            startX: d,
            startY: p,
            currentX: d,
            currentY: p
        ...
        if (i.isTouchEvent && t.activeElement && o.target === t.activeElement && C(o.target).is(i.focusableElements)) return i.isMoved = !0, void(s.allowClick = !1);
        ...
        if (void 0 === i.isScrolling) {
            let e;
            s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI, i.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
        }
        ...
        s.allowClick = !1, !n.cssMode && o.cancelable && o.preventDefault(), n.touchMoveStopPropagation && !n.nested && o.stopPropagation(), i.isMoved || (n.loop && !n.cssMode && s.loopFix(), i.startTranslate = s.getTranslate(), s.setTransition(0), s.animating && s.$wrapperEl.trigger("webkitTransitionEnd transitionend"), i.allowMomentumBounce = !1, !n.grabCursor || !0 !== s.allowSlideNext && !0 !== s.allowSlidePrev || s.setGrabCursor(!0), s.emit("sliderFirstMove", o)), s.emit("sliderMove", o), i.isMoved = !0;
        let f = s.isHorizontal() ? h : m;
        a.diff = f, f *= n.touchRatio, l && (f = -f), s.swipeDirection = f > 0 ? "prev" : "next", i.currentTranslate = f + i.startTranslate;
        let g = !0,
            v = n.resistanceRatio;
    ...
    function R(e) {
        ...
        for (let e = 0; e < l.length; e += e < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
            ...
            void 0 !== l[e + t] ? p >= l[e] && p < l[e + t] && (u = e, h = l[e + t] - l[e]) : p >= l[e] && (u = e, h = l[l.length - 1] - l[l.length - 2])
        }
        let m = null,
            f = null;
        ...
        if (d > i.longSwipesMs) {
            ...
            "next" === t.swipeDirection && (g >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? m : u + v) : t.slideTo(u)), "prev" === t.swipeDirection && (g > 1 - i.longSwipesRatio ? t.slideTo(u + v) : null !== f && g < 0 && Math.abs(g) > i.longSwipesRatio ? t.slideTo(f) : t.slideTo(u))
        } else {
    ...
    const Z = (e, t) => {
        const s = u(),
            ...
            p = t;
        if (o.touch) {
            const t = !("touchstart" !== n.start || !o.passiveListener || !i.passiveListeners) && {
                passive: !0,
                capture: !1
            };
            a[d](n.start, e.onTouchStart, t), a[d](n.move, e.onTouchMove, o.passiveListener ? {
                passive: !1,
                capture: c
        ...
        (i.preventClicks || i.preventClicksPropagation) && a[d]("click", e.onClick, !0), i.cssMode && l[d]("scroll", e.onScroll), i.updateOnWindowResize ? e[p](r.ios || r.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", X, !0) : e[p]("observerUpdate", X, !0)
    };
    const J = {
            attachEvents: function () {
                ...
                e.onTouchStart = V.bind(e), e.onTouchMove = W.bind(e), e.onTouchEnd = R.bind(e), s.cssMode && (e.onScroll = U.bind(e)), e.onClick = Y.bind(e), i.touch && !Q && (t.addEventListener("touchstart", K), Q = !0), Z(e, "on")
            },
    ...
    const te = {
        setBreakpoint: function () {
            ...
            const o = (r in l ? l[r] : void 0) || e.originalParams,
                ...
                d = ee(e, o),
                p = n.enabled;
            c && !d ? (a.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`), e.emitContainerClasses()) : !c && d && (a.addClass(`${n.containerModifierClass}grid`), (o.grid.fill && "column" === o.grid.fill || !o.grid.fill && "column" === n.grid.fill) && a.addClass(`${n.containerModifierClass}grid-column`), e.emitContainerClasses());
            ...
            }), p && !m ? e.disable() : !p && m && e.enable(), e.currentBreakpoint = r, e.emit("_beforeBreakpoint", o), h && s && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - i + e.loopedSlides, 0, !1)), e.emit("breakpoint", o)
        },
    ...
    const ae = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), H({
                        swiper: s,
                        runCallbacks: e,
                        direction: t,
                        step: "Start"
                ...
                transitionEnd: function (e, t) {
                    ...
                    s.animating = !1, i.cssMode || (s.setTransition(0), H({
                        swiper: s,
                        runCallbacks: e,
                        direction: t,
                        step: "End"
            ...
            images: {
                loadImage: function (e, t, s, i, n, a) {
                    ...
                    C(e).parent("picture")[0] || e.complete && n ? o() : t ? (r = new l.Image, r.onload = o, r.onerror = o, i && (r.sizes = i), s && (r.srcset = s), t && (r.src = t)) : o()
                },
    ...
    class re {
        constructor() {
            ...
            if (1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = M({}, t), e && !t.el && (t.el = e), t.el && C(t.el).length > 1) {
                const e = [];
            ...
            const a = this;
            a.__swiper__ = !0, a.support = z(), a.device = D({
                userAgent: t.userAgent
            }), a.browser = B(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
            const l = {};
            a.modules.forEach((e => {
                e({
                    swiper: a,
            ...
            const r = M({}, ie, l);
            return a.params = M({}, r, le, t), a.originalParams = M({}, a.params), a.passedParams = M({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
        ...
        mount(e) {
            ...
            if (0 === n.length && t.params.createElements) {
                ...
                n = C(e), e.className = t.params.wrapperClass, s.append(e), s.children(`.${t.params.slideClass}`).each((e => {
                    n.append(e)
                }))
            }
            ...
            t.params.resizeObserver && void 0 !== n.ResizeObserver ? t && !t.destroyed && t.initialized && (a = new ResizeObserver((e => {
                l = n.requestAnimationFrame((() => {
                    ...
                    e.forEach((e => {
                        ...
                        l && l !== t.el || (n = i ? i.width : (s[0] || s).inlineSize, a = i ? i.height : (s[0] || s).blockSize)
                    })), n === s && a === i || r()
                }))
            })), a.observe(t.el)) : (n.addEventListener("resize", r), n.addEventListener("orientationchange", o))
        })), s("destroy", (() => {
            l && n.cancelAnimationFrame(l), a && a.unobserve && t.el && (a.unobserve(t.el), a = null), n.removeEventListener("resize", r), n.removeEventListener("orientationchange", o)
        }))
    }, function (e) {
        let {
            swiper: t,
    ...
    function de(e) {
        ...
        s({
            ...
            if (t.params.navigation.hideOnClick && !C(l).is(a) && !C(l).is(i)) {
    ...
    function ue(e) {
        ...
        function d() {
            ...
            if (t.params.loop ? (d = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup), d > i - 1 - 2 * t.loopedSlides && (d -= i - 2 * t.loopedSlides), d > p - 1 && (d -= p), d < 0 && "bullets" !== t.params.paginationType && (d = p + d)) : d = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0, "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                let n, o, p;
                if (s.dynamicBullets && (l = i.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0), a.css(t.isHorizontal() ? "width" : "height", l * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (r += d - (t.previousIndex - t.loopedSlides || 0), r > s.dynamicMainBullets - 1 ? r = s.dynamicMainBullets - 1 : r < 0 && (r = 0)), n = Math.max(d - r, 0), o = n + (Math.min(i.length, s.dynamicMainBullets) - 1), p = (o + n) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), a.length > 1) i.each((e => {
                    const t = C(e),
                        i = t.index();
            ...
            if ("fraction" === s.type && (a.find(pe(s.currentClass)).text(s.formatFractionCurrent(d + 1)), a.find(pe(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
                let e;
                e = s.progressbarOpposite ? t.isHorizontal() ? "vertical" : "horizontal" : t.isHorizontal() ? "horizontal" : "vertical";
                const i = (d + 1) / p;
                let n = 1,
                    l = 1;
                "horizontal" === e ? n = i : l = i, a.find(pe(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${l})`).transition(t.params.speed)
            }
            "custom" === s.type && s.renderCustom ? (a.html(s.renderCustom(t, d + 1, p)), n("paginationRender", a[0])) : n("paginationUpdate", a[0]), t.params.watchOverflow && t.enabled && a[t.isLocked ? "addClass" : "removeClass"](s.lockClass)
        }
        ...
        function h() {
            ...
            s.removeClass(e.hiddenClass), s.removeClass(e.modifierClass + e.type), s.removeClass(t.isHorizontal() ? e.horizontalClass : e.verticalClass), t.pagination.bullets && t.pagination.bullets.removeClass && t.pagination.bullets.removeClass(e.bulletActiveClass), e.clickable && s.off("click", pe(e.bulletClass))
        }
        i("init", (() => {
            u(), p(), d()
        })), i("activeIndexChange", (() => {
    ...
    function he(e) {
        ...
        function l() {
            ...
            e.attr("data-swiper-autoplay") && (i = e.attr("data-swiper-autoplay") || s.params.autoplay.delay), clearTimeout(t), t = E((() => {
                let e;
                s.params.autoplay.reverseDirection ? s.params.loop ? (s.loopFix(), e = s.slidePrev(s.params.speed, !0, !0), a("autoplay")) : s.isBeginning ? s.params.autoplay.stopOnLastSlide ? o() : (e = s.slideTo(s.slides.length - 1, s.params.speed, !0, !0), a("autoplay")) : (e = s.slidePrev(s.params.speed, !0, !0), a("autoplay")) : s.params.loop ? (s.loopFix(), e = s.slideNext(s.params.speed, !0, !0), a("autoplay")) : s.isEnd ? s.params.autoplay.stopOnLastSlide ? o() : (e = s.slideTo(0, s.params.speed, !0, !0), a("autoplay")) : (e = s.slideNext(s.params.speed, !0, !0), a("autoplay")), (s.params.cssMode && s.autoplay.running || !1 === e) && l()
            }), i)
        }

        function r() {
            return void 0 === t && (!s.autoplay.running && (s.autoplay.running = !0, a("autoplayStart"), l(), !0))
        }
        ...
        function p(e) {
            ...
            })), s.autoplay.paused = !1, s.autoplay.running ? l() : o())
        }

        function h() {
            s.params.autoplay.disableOnInteraction ? o() : (a("autoplayPause"), c()), ["transitionend", "webkitTransitionEnd"].forEach((e => {
                s.$wrapperEl[0].removeEventListener(e, p)
            }))
        }
        ...
        s.autoplay = {
            ...
            if (s.params.autoplay.enabled) {
                r();
                u().addEventListener("visibilitychange", d), s.params.autoplay.pauseOnMouseEnter && (s.$el.on("mouseenter", h), s.$el.on("mouseleave", m))
            }
        })), n("beforeTransitionStart", ((e, t, i) => {
            s.autoplay.running && (i || !s.params.autoplay.disableOnInteraction ? s.autoplay.pause(t) : o())
        })), n("sliderFirstMove", (() => {
            s.autoplay.running && (s.params.autoplay.disableOnInteraction ? o() : c())
        })), n("touchEnd", (() => {
            s.params.cssMode && s.autoplay.paused && !s.params.autoplay.disableOnInteraction && l()
        })), n("destroy", (() => {
            s.$el.off("mouseenter", h), s.$el.off("mouseleave", m), s.autoplay.running && o();
                ...
                (s ? t.slides.find(s) : t.slides).transition(e),
                    function (e) {
                        ...
                        if (t.params.virtualTranslate && 0 !== s) {
                            let e, s = !1;
                            e = n ? i ? a.find(i) : a : i ? a.eq(l).find(i) : a.eq(l), e.transitionEnd((() => {
                                if (s) return;
    ...
    window.addEventListener("load", (function (e) {
        document.querySelector(".collections__slider-body") && new oe(".collections__slider-body", {
            modules: [de, ue, he],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            on: {}
        }), document.querySelector(".trending__swiper") && new oe(".trending__swiper", {
            modules: [de, ue, fe],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
            ...
            on: {}
        }), document.querySelector(".customers__slider") && new oe(".customers__slider", {
            modules: [de, ue, he],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
    ...
    new ge("max").init(), document.querySelectorAll("._select").forEach((function (e) {
        const t = e.querySelector("._select-button"),
            s = e.querySelector("._select-list"),
            i = s.querySelectorAll("._select-item"),
            n = e.querySelector("._select-hidden");
        t.addEventListener("click", (function () {
            s.classList.toggle("_list_visible")
        })), i.forEach((function (e) {
            e.addEventListener("click", (function (e) {
                e.stopImmediatePropagation, t.innerText = this.innerText, n.value = this.dataset.value, s.classList.remove("_list_visible")
            }))
        })), document.addEventListener("click", (function (e) {
            e.target !== t && s.classList.remove("_list_visible")
        })), document.addEventListener("keydown", (function (e) {
            "Tab" !== e.key && "Escape" !== e.key || s.classList.remove("_list_visible")
        }))
    }));
    const ve = document.querySelector(".header").cloneNode(!0),
        Se = document.querySelector(".header__wrapper");
    ve.classList.add("header--fixed"), Se.append(ve), $(window).scroll((function () {
            console.log($(window).scrollTop()), $(window).scrollTop() > 250 ? ve.classList.add("header--is-show") : ve.classList.remove("header--is-show")
        })), window.FLS = !0,
        function (e) {
            let t = new Image;
        ...
        function () {
            ...
            if (e.length > 0) {
                ...
                function a(e, t = !1) {
                    e.forEach((e => {
                        e = t ? e.item : e, t.matches || !t ? (e.classList.add("_spoller-init"), l(e), e.addEventListener("click", o)) : (e.classList.remove("_spoller-init"), l(e, !1), e.removeEventListener("click", o))
                    }))
                }
                ...
                function o(e) {
                    ...
                    if (t.closest("[data-spoller]")) {
                        const s = t.closest("[data-spoller]"),
                            ...
                            l = n.dataset.spollersSpeed ? parseInt(n.dataset.spollersSpeed) : 500;
                        n.querySelectorAll("._slide").length || (a && !s.classList.contains("_spoller-active") && c(n), s.classList.toggle("_spoller-active"), i(s.nextElementSibling, l)), e.preventDefault()
                    }
                }
                ...
                function c(e) {
                    ...
                    s && !e.querySelectorAll("._slide").length && (s.classList.remove("_spoller-active"), t(s.nextElementSibling, i))
                }
                ...
                d.length && document.addEventListener("click", (function (e) {
                    e.target.closest("[data-spollers]") || d.forEach((e => {
        ...
        function () {
            ...
            e.length > 0 && function () {
                ...
                function n(e) {
                    t = e.querySelector(".rating__active"), s = e.querySelector(".rating__value")
                }
                ...
                function l(e) {
                    ...
                    for (let i = 0; i < t.length; i++) {
                        ...
                        l.addEventListener("mouseenter", (function (t) {
                            ...
                            n(e), e.dataset.ajax ? r(l.value, e) : (s.innerHTML = i + 1, a())
                        }))
                    }
                }
